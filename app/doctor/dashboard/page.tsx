...
import { Calendar, Clock, Users, FileText, User, LogOut, Stethoscope, Plus, Eye } from 'lucide-react';
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex flex-col items-end space-y-2">
                          ...
                          <div className="flex space-x-2">
                            ...
                            <Link
                              href={`/doctor/medical-records/create?patientId=${appointment.patientID._id}&appointmentId=${appointment._id}`}
